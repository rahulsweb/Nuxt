<template>
  <section class="pricing-one" id="pricing">
    <div class="container">
      <div class="block-title text-center text-justify">
        <h2 class="block-title__title"><span>Pricing Plans</span></h2>
        <!-- /.block-title__title -->
      </div>
      <!-- /.block-title -->
          ...
          <div class="service-one__single text-center">
            <div class="service-one__inner">
              ...
              <ul class="list-unstyled mt-5 p-3">
                ...
                <li>one-to-one and conference/webinar</li>
                <li>SMS/email notification</li>
                <li>Extra rooms $9.99/month</li>
                <li>Calendar Syncronization</li>
              </ul>
            </div>
            <!-- /.service-one__inner -->
          </div>
